...
// Official brand logomarks (Simple Icons / svgl), rendered solid white, no background.

// Anthropic / Claude — Simple Icons "claude".
...
// OpenAI / Codex — svgl "openai".
function CodexLogo({ className, ...props }: LogoProps) {
  return (
    <svg viewBox="0 0 256 260" className={className} {...props}>
      <path
        fill="#ffffff"
...
function OpenCodeLogo({ className, ...props }: LogoProps) {
  return (
    <svg viewBox="0 0 24 24" className={className} {...props}>
      <path fill="#ffffff" d="M22 24H2V0h20zM17 4.8H7v14.4h10z" />
    </svg>
  );
}
